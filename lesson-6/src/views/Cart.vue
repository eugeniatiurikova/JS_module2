  ...
  <div class="page">
    ...
    <section class="cart">
      ...
      <div class="cart_inside container">
        ...
        <CartFormCheckout v-bind:data="cart" v-bind:sum="cartsum"
          ><p class="form_sub_total">
            Sub total<span class="chekout_price">${{ cartsum }}</span>
          </p>
...
import CartFormCheckout from "../components/CartFormCheckout.vue";
import InnerTitle from "../components/InnerTitle.vue";

export default {
  name: "Cart",
  components: { CartProductCard, CartFormCheckout, InnerTitle },
  props: ["cart", "catalog", "cartsum"],
  computed: {
    CartEmpty() {
