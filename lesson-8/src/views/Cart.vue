      ...
      <div class="cart_inside container">
        <div class="cart_cards_wrap">
          ...
          <div class="cart_buttons_wrap">
            <button type="button" class="cart_button" @click="onDispose">
              Clear shopping cart
            </button>
          ...
          <div class="cart_form_checkout">
            <div class="cart_prices">
              <p class="form_sub_total">
                Sub total<span class="chekout_price">${{ totalcheck }}.00</span>
              </p>
              <p class="cart_form_title">
                Grand total<span class="main_red_text chekout_price"
                  ><b>${{ totalcheck }}.00</b></span
                >
              </p>
            </div>
...
export default {
  ...
  computed: {
    ...
    totalcheck() {
      return this.$store.getters.getTotalCheck;
    },
  },
  methods: {
    onDispose() {
      this.$store.dispatch("disposeCart");
    },
  },
};
</script>
